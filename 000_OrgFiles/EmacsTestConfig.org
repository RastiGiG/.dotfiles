...
#+DATE:     [2024-01-04]
#+DESCRIPTION: Test Configuration to work out changes and try new packages
#+PROPERTY: header-args:emacs-lisp :tangle ../C01_EmacsConfiguration/.emacs-test.d/init.el :mkdirp yes
...
** Evil Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/evil_config.el :mkdirp yes
:END:
...
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/general_standard_config.el :mkdirp yes
:END:
...
*** Evil Version
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/general_evil_config.el :mkdirp yes
:END:
...
*** Leader Keys
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/general_leader_keys.el :mkdirp yes
:END:
...
** Which Key
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/which_key_config.el :mkdirp yes
:END:
...
** Dired Extensions
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/dired_extensions_config.el :mkdirp yes
:END:
*** Dired Open
...
** Ranger
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/ranger_config.el :mkdirp yes
:END:
...
** PDF Tools
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/pdf_tools_config.el :mkdirp yes
:END:
...
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/qol_collection_config.el :mkdirp yes
:END:
...
** Multiple Cursors
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/multiple_cursors_config.el :mkdirp yes
:END:
...
** Undo-Tree
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/undo_tree_config.el :mkdirp yes
:END:
...
** Projectile
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/projectile_config.el :mkdirp yes
:END:
...
** YASnippets
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/yasnippets_config.el :mkdirp yes
:END:
...
** All The Icons
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/all_the_icons_config.el :mkdirp yes
:END:
...
** Doom Modeline
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/doom_modeline_config.el :mkdirp yes
:END:
...
** Themes
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/themes_config.el :mkdirp yes
:END:
*** Doom Themes
...
** Perspective
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/perspective_config.el :mkdirp yes
:END:
...
** Dashboard
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/dashboard_config.el :mkdirp yes
:END:
...
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/ivy_config.el :mkdirp yes
:END:
*** Description
...
** Hydra
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/hydra_config.el :mkdirp yes
:END:
*** Description
...
** Treemacs Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/treemacs_config.el :mkdirp yes
:END:
*** Load Treemacs
...
** Neotree
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/neotree_config.el :mkdirp yes
:END:
...
** Beacon
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/beacon_config.el :mkdirp yes
:END:
...
** GUI Extensions
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/gui_extensions_config.el :mkdirp yes
:END:
*** Command Log Mode
...
** Magit
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/magit_config.el :mkdirp yes
:END:
...
** Consult
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/consult_config.el :mkdirp yes
:END:
...
** Company Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/company_config.el :mkdirp yes
:END:
*** Load Company Mode
...
** Dev Tool Collection
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/dev_tools_collection_config.el :mkdirp yes
:END:
*** Flycheck
...
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/language_modes_config.el :mkdirp yes
:END:
***** Octave/Matlab
...
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/language_ts_modes_config.el :mkdirp yes
:END:
*** Language Servers
**** LSP Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/lsp_mode_config.el :mkdirp yes
:END:
***** Setup
...
**** Eglot
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/eglot_config.el :mkdirp yes
:END:
***** Setup
...
** Vterm
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/vterm_config.el :mkdirp yes
:END:
...
** Eshell
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/eshell_config.el :mkdirp yes
:END:
...
* Org Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/org_config.el :mkdirp yes
:END:
...
* Legder Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/ledger_mode_config.el :mkdirp yes
:END:
...
* Citeproc
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/citeproc_config.el :mkdirp yes
:END:
...
** mu4e
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/mu4e_config.el :mkdirp yes
:END:
...
** Password Store
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/password_store_config.el :mkdirp yes
:END:
#+begin_src emacs-lisp
...
** EBDB
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/ebdb_config.el :mkdirp yes
:END:
...
* ERC
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/erc_config.el :mkdirp yes
:END:
...
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs-test.d/package_configs/elfeed_config.el :mkdirp yes
:END:
** Load Elfeed
