...
#+DATE:         [2024-01-06]
#+MODIFIED:     Time-stamp: <2024-10-25 20:34:59 rastibasti>
...
Load [[https://github.com/jolby/ob-zig.el][Ob-zig]] to support the [[id:af113201-ed84-4d96-8b34-a23bd0b1fcc2][Zig Programming Language]]
#+begin_src emacs-lisp
...
[[file:~/Projects/InfoFiles/Emacs/Worg/org-contrib/babel/languages/index.org][Org Babel Supported Languages]] documents all of the languages that you can use with =org-babel=.
...
* Markdown Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs.d/package_configs/markdown_config.el :mkdirp yes
:END:
#+begin_src emacs-lisp
...
* EBuku
:PROPERTIES:
:header-args:emacs-lisp: :tangle ../C01_EmacsConfiguration/.emacs.d/package_configs/ebuku_config.el :mkdirp yes
:END:
[[https://github.com/flexibeast/ebuku][Ebuku]] is an ~interface~ to the [[https://github.com/jarun/buku][buku]] ~Web Bookmark Manager~ for [[id:3cf0fa83-18b3-4206-a109-f4606a94b8c1][Emacs]].
#+begin_src emacs-lisp
